...
func draw_elevator(canvas_item: RID, coords: Vector3i, pos: Vector2, size: Vector2, data: String):
	...
	var elevator_texture := preload("res://CoreEngine/Sprites/Objects/Elevator.png")
...
func draw_overlay(canvas_item: RID, coords: Vector3i, pos: Vector2, size: Vector2, data: String):
